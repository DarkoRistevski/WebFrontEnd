...
import AddIngredient from "../CreateRecipe/Modal/AddIngredient";
...
class Edit extends Component{
    ...
    isFormValid = (e) => {
        ...
        if(this.state.ingredients.length == 0 || (this.checkIfAllEmpty(this.state.ingredients))){
            document.getElementById("createIngredientsEdit").classList.add("invalidBorder");
            flag = false;
        } else {
            document.getElementById("createIngredientsEdit").classList.remove("invalidBorder");
        }

        if(this.state.instructions.length == 0 || (this.checkIfAllEmpty(this.state.instructions))){
            document.getElementById("createInstructionsEdit").classList.add("invalidBorder");
            flag = false;
        } else {
            document.getElementById("createInstructionsEdit").classList.remove("invalidBorder");
        }
    ...
    onSubmitHandler = (e) => {
        ...
        if(this.isFormValid(e)){
            ...
            formData.append("image", this.state.image == null ? "null" : this.state.image);

            recipeService.updateRecipe(formData).then((response) => {
                                    ...
                                    <form className="form-create mt-4" onSubmit={this.onSubmitHandler}>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-10">
                                                <ol style={{width: '100%', marginLeft: '-1.1%'}}>
                                                    <div id="createIngredientsEdit" className="form-control">
                                        ...
                                        <div className="form-group row mb-0 minusPadding">
                                            <label className="col-sm-2 col-form-label"
                                                   htmlFor="inputInstructions">Instructions</label>
                                            <div className="col-sm-10">
                                                <ol style={{width: '100%', marginLeft: '-1.1%'}}>
                                                    <div id="createInstructionsEdit" className="form-control">
